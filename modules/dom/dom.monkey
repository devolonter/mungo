...
Class Window Extends EventTarget
	...
	Method focus()
	Method blur()
	Method open:Window( url:String, target:String, features:String, replace:String )
...
Class Document Extends Node
	...
	Method getElementsByTagName:NodeList( qualifiedName:String )
...
'	Field validity:ValidityState
	...
	Method setCustomValidity( Error:String )
End

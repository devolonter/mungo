...
#If TARGET<>"glfw" And TARGET<>"android" And TARGET<>"ios" And TARGET<>"html5" And TARGET <> "psm" And TARGET <> "winrt"
	#Error "TODO!" ''note: TODO Error message
#Endif
...
#If TARGET="glfw" And HOST = "winnt" And Not GLFW_USE_ANGLE_GLES20

#OPENGL_INIT_EXTENSIONS=True
Import "native/gl.${TARGET}.${HOST}.${LANG}"
	
#End

#If LANG="cpp"

Import "native/gl.${LANG}"
	
#End

Import "native/gl.${TARGET}.${LANG}"
...
Function glBufferData:Void( target, size, data:Float[], usage )="_glBufferData"
Function glBufferSubData:Void( target, offset, size, data:DataBuffer )="_glBufferSubData"
Function glBufferSubData:Void( target, offset, size, from, data:DataBuffer )="_glBufferSubData"
Function glBufferSubData:Void( target, offset, size, data:Float[] )="_glBufferSubData"
Function glBufferSubData:Void( target, offset, size, from, data:Float[] )="_glBufferSubData"
...
Function glReadPixels:Void( x, y, width, height, format, type, pixels[] )="_glReadPixels"
Function glReadPixels:Void( x, y, width, height, format, type, pixels[], offset, pitch )="_glReadPixels"
Function glReadPixels32:Void( x, y, width, height, pixels[] )="_glReadPixels32"
Function glReadPixels32:Void( x, y, width, height, pixels[], offset, pitch )="_glReadPixels32"
Function glReadPixelsFlipped:Void( x, y, width, height, format, type, pixels[] )="_glReadPixelsFlipped"
Function glReadPixelsFlipped:Void( x, y, width, height, format, type, pixels[], offset, pitch )="_glReadPixelsFlipped"
Function glReadPixelsFlipped32:Void( x, y, width, height, pixels[] )="_glReadPixelsFlipped32"
Function glReadPixelsFlipped32:Void( x, y, width, height, pixels[], offset, pitch )="_glReadPixelsFlipped32"
...
Function glTexSubImage2D:Void( target, level, xoffset, yoffset, width, height, format, type, from, pixels:DataBuffer )="_glTexSubImage2D"
...
Function glTexUploadImage2D:Void( path:String,textureId,pixmap:DataBuffer,target,format,type,padded:Bool,listener:EventListener,result[] )="_glTexUploadImage2D"
Function glPixmapSetPixel:Void( color,pixmap:DataBuffer,offset,format,type )="_glPixmapSetPixel"
Function glPixmapSetPixel32:Void( color,pixmap:DataBuffer,offset,format,type )="_glPixmapSetPixel32"
Function glPixmapSetPixels:Void( pixels[],srcOffset,pixmap:DataBuffer,dstOffset,pitch,width,height,format,type )="_glPixmapSetPixels"
Function glPixmapSetPixels32:Void( pixels[],srcOffset,pixmap:DataBuffer,dstOffset,pitch,width,height,format,type )="_glPixmapSetPixels32"
Function glPixmapGetPixel:Int( pixmap:DataBuffer,offset,format,type )="_glPixmapGetPixel"
Function glPixmapGetPixel32:Int( pixmap:DataBuffer,offset,format,type )="_glPixmapGetPixel32"
Function glPixmapGetPixels:Void( pixmap:DataBuffer,srcOffset,pitch,width,height,format,type,pixels[],dstOffset )="_glPixmapGetPixels"
Function glPixmapGetPixels32:Void( pixmap:DataBuffer,srcOffset,pitch,width,height,format,type,pixels[],dstOffset )="_glPixmapGetPixels32"
Function glPixmapClearPixels:Void( pixmap:DataBuffer,color,format,type )="_glPixmapClearPixels"
Function glPixmapClearPixels32:Void( pixmap:DataBuffer,color,format,type )="_glPixmapClearPixels32"
'${END}

#End

#If TARGET="glfw" And Not GLFW_USE_ANGLE_GLES20
...
#LIBS+="${CD}/native/libs/x86/libharmony-gl.so"
#LIBS+="${CD}/native/libs/x86_64/libharmony-gl.so"
#LIBS+="${CD}/native/libs/mips/libharmony-gl.so"
#LIBS+="${CD}/native/libs/mips64/libharmony-gl.so"
#LIBS+="${CD}/native/libs/armeabi/libharmony-gl.so"
#LIBS+="${CD}/native/libs/armeabi/libharmony-gl.so"
#LIBS+="${CD}/native/libs/arm64-v8a/libharmony-gl.so"

#SRCS+="${CD}/native/jni/src/com/mungo/harmony/NHGL.java"
...
Function glBufferData:Void( target, size, data:DataBuffer, usage )="HGL.glBufferData"
Function glBufferData:Void( target, size, data:Float[], usage )="NHGL.glBufferData"
Function glBufferSubData:Void( target, offset, size, data:DataBuffer )="HGL.glBufferSubData"
Function glBufferSubData:Void( target, offset, size, from, data:DataBuffer )="HGL.glBufferSubData"
Function glBufferSubData:Void( target, offset, size, data:Float[] )="NHGL.glBufferSubData"
Function glBufferSubData:Void( target, offset, size, from, data:Float[] )="NHGL.glBufferSubData"
...
Function glCreateBuffer:Int()="HGL.glCreateBuffer"
Function glCreateFramebuffer:Int()="HGL.glCreateFramebuffer"
Function glCreateRenderbuffer:Int()="HGL.glCreateRenderbuffer"
Function glCreateTexture:Int()="HGL.glCreateTexture"
Function glCreateProgram:Int()="GLES20.glCreateProgram"
Function glCreateShader:Int( type )="GLES20.glCreateShader"
Function glDeleteBuffer:Void( buffer )="HGL.glDeleteBuffer"
Function glDeleteFramebuffer:Void( framebuffer )="HGL.glDeleteFramebuffer"
Function glDeleteRenderbuffer:Void( renderBuffer )="HGL.glDeleteRenderbuffer"
Function glDeleteTexture:Void( texture )="HGL.glDeleteTexture"
...
Function glGetActiveAttrib:Void( program, index, size[], type[], name$[] )="HGL.glGetActiveAttrib"
Function glGetActiveUniform:Void( program, index, size[], type[], name$[] )="HGL.glGetActiveUniform"
Function glGetAttachedShaders:Void( program, maxcount, count[], shaders[] )="HGL.glGetAttachedShaders"
Function glGetAttribLocation:Int( program, name$ )="GLES20.glGetAttribLocation"
Function glGetBooleanv:Void( pname, params?[] )="HGL.glGetBooleanv"
Function glGetBufferParameteriv:Void( target, pname, params[] )="HGL.glGetBufferParameteriv"
Function glGetError:Int()="GLES20.glGetError"
Function glGetFloatv:Void( pname, params#[] )="HGL.glGetFloatv"
Function glGetFramebufferAttachmentParameteriv:Void( target, attachment, pname, params[] )="HGL.glGetFramebufferAttachmentParameteriv"
Function glGetIntegerv:Void( pname, params[] )="HGL.glGetIntegerv"
Function glGetProgramiv:Void( program, pname, params[] )="HGL.glGetProgramiv"
Function glGetProgramInfoLog:String( program )="GLES20.glGetProgramInfoLog"
Function glGetRenderbufferParameteriv:Void( target, pname, params[] )="HGL.glGetRenderbufferParameteriv"
Function glGetShaderiv:Void( shader, pname, params[] )="HGL.glGetShaderiv"
Function glGetShaderInfoLog:String( shader )="GLES20.glGetShaderInfoLog"
Function glGetShaderSource:String( shader )="HGL.glGetShaderSource"
Function glGetString:String( name )="GLES20.glGetString"
Function glGetTexParameterfv:Void( target, pname, params#[] )="HGL.glGetTexParameterfv"
Function glGetTexParameteriv:Void( target, pname, params[] )="HGL.glGetTexParameteriv"
Function glGetUniformfv:Void( program, location, params#[] )="HGL.glGetUniformfv"
Function glGetUniformiv:Void( program, location, params[] )="HGL.glGetUniformiv"
Function glGetUniformLocation:Int( program, name$ )="GLES20.glGetUniformLocation"
Function glGetVertexAttribfv:Void( index, pname, params#[] )="HGL.glGetVertexAttribfv"
Function glGetVertexAttribiv:Void( index, pname, params[] )="HGL.glGetVertexAttribiv"
...
Function glReadPixels:Void( x, y, width, height, format, type, pixels:DataBuffer )="HGL.glReadPixels"
Function glReadPixels:Void( x, y, width, height, format, type, pixels[] )="NHGL.glReadPixels"
Function glReadPixels:Void( x, y, width, height, format, type, pixels[], offset, pitch )="NHGL.glReadPixels"
Function glReadPixels32:Void( x, y, width, height, pixels[] )="NHGL.glReadPixels32"
Function glReadPixels32:Void( x, y, width, height, pixels[], offset, pitch )="NHGL.glReadPixels32"
Function glReadPixelsFlipped:Void( x, y, width, height, format, type, pixels[] )="NHGL.glReadPixelsFlipped"
Function glReadPixelsFlipped:Void( x, y, width, height, format, type, pixels[], offset, pitch )="NHGL.glReadPixelsFlipped"
Function glReadPixelsFlipped32:Void( x, y, width, height, pixels[] )="NHGL.glReadPixelsFlipped32"
Function glReadPixelsFlipped32:Void( x, y, width, height, pixels[], offset, pitch )="NHGL.glReadPixelsFlipped32"
...
Function glTexImage2D:Void( target, level, internalformat, width, height, border, format, type, pixels:DataBuffer )="HGL.glTexImage2D"
Function glTexSubImage2D:Void( target, level, xoffset, yoffset, width, height, format, type, pixels:DataBuffer )="HGL.glTexSubImage2D"
Function glTexSubImage2D:Void( target, level, xoffset, yoffset, width, height, format, type, from, pixels:DataBuffer )="HGL.glTexSubImage2D"
...
Function glUniform1fv:Void( location, count, v#[] )="HGL.glUniform1fv"
Function glUniform1iv:Void( location, count, v[] )="HGL.glUniform1iv"
Function glUniform2fv:Void( location, count, v#[] )="HGL.glUniform2fv"
Function glUniform2iv:Void( location, count, v[] )="HGL.glUniform2iv"
Function glUniform3fv:Void( location, count, v#[] )="HGL.glUniform3fv"
Function glUniform3iv:Void( location, count, v[] )="HGL.glUniform3iv"
Function glUniform4fv:Void( location, count, v#[] )="HGL.glUniform4fv"
Function glUniform4iv:Void( location, count, v[] )="HGL.glUniform4iv"
Function glUniformMatrix2fv:Void( location, count, transpose?, value#[] )="HGL.glUniformMatrix2fv"
Function glUniformMatrix3fv:Void( location, count, transpose?, value#[] )="HGL.glUniformMatrix3fv"
Function glUniformMatrix4fv:Void( location, count, transpose?, value#[] )="HGL.glUniformMatrix4fv"
...
Function glVertexAttrib1fv:Void( indx, values#[] )="HGL.glVertexAttrib1fv"
Function glVertexAttrib2fv:Void( indx, values#[] )="HGL.glVertexAttrib2fv"
Function glVertexAttrib3fv:Void( indx, values#[] )="HGL.glVertexAttrib3fv"
Function glVertexAttrib4fv:Void( indx, values#[] )="HGL.glVertexAttrib4fv"
...
Function glTexUploadImage2D:Void( path:String,textureId,pixmap:DataBuffer,target,format,type,padded:Bool,listener:EventListener,result[] )="HGL.glTexUploadImage2D"
Function glPixmapSetPixel:Void( color,pixmap:DataBuffer,offset,format,type )="HGL.glPixmapSetPixel"
Function glPixmapSetPixel32:Void( color,pixmap:DataBuffer,offset,format,type )="HGL.glPixmapSetPixel32"
Function glPixmapSetPixels:Void( pixels[],srcOffset,pixmap:DataBuffer,dstOffset,pitch,width,height,format,type )="HGL.glPixmapSetPixels"
Function glPixmapSetPixels32:Void( pixels[],srcOffset,pixmap:DataBuffer,dstOffset,pitch,width,height,format,type )="HGL.glPixmapSetPixels32"
Function glPixmapGetPixel:Int( pixmap:DataBuffer,offset,format,type )="HGL.glPixmapGetPixel"
Function glPixmapGetPixel32:Int( pixmap:DataBuffer,offset,format,type )="HGL.glPixmapGetPixel32"
Function glPixmapGetPixels:Void( pixmap:DataBuffer,srcOffset,pitch,width,height,format,type,pixels[],dstOffset )="HGL.glPixmapGetPixels"
Function glPixmapGetPixels32:Void( pixmap:DataBuffer,srcOffset,pitch,width,height,format,type,pixels[],dstOffset )="HGL.glPixmapGetPixels32"
Function glPixmapClearPixels:Void( pixmap:DataBuffer,color,format,type )="HGL.glPixmapClearPixels"
Function glPixmapClearPixels32:Void( pixmap:DataBuffer,color,format,type )="HGL.glPixmapClearPixels32"
'${END}

#ElseIf TARGET="ios"

Function glEndRender:Void()="_glEndRender"
...
Function glBufferData:Void( target, size, data:DataBuffer, usage )="_glBufferData"
Function glBufferData:Void( target, size, data:Float[], usage )="_glBufferData2"
Function glBufferSubData:Void( target, offset, size, data:DataBuffer )="_glBufferSubData"
Function glBufferSubData:Void( target, offset, size, from, data:DataBuffer )="_glBufferSubData2"
Function glBufferSubData:Void( target, offset, size, data:Float[] )="_glBufferSubData3"
Function glBufferSubData:Void( target, offset, size, from, data:Float[] )="_glBufferSubData4"
...
Function glReadPixels:Void( x, y, width, height, format, type, pixels:DataBuffer )="_glReadPixels"
Function glReadPixels:Void( x, y, width, height, format, type, pixels[] )="_glReadPixels2"
Function glReadPixels:Void( x, y, width, height, format, type, pixels[], offset, pitch )="_glReadPixels3"
Function glReadPixels32:Void( x, y, width, height, pixels[] )="_glReadPixels32"
Function glReadPixels32:Void( x, y, width, height, pixels[], offset, pitch )="_glReadPixels322"
Function glReadPixelsFlipped:Void( x, y, width, height, format, type, pixels[] )="_glReadPixelsFlipped"
Function glReadPixelsFlipped:Void( x, y, width, height, format, type, pixels[], offset, pitch )="_glReadPixelsFlipped2"
Function glReadPixelsFlipped32:Void( x, y, width, height, pixels[] )="_glReadPixelsFlipped32"
Function glReadPixelsFlipped32:Void( x, y, width, height, pixels[], offset, pitch )="_glReadPixelsFlipped322"
...
Function glTexImage2D:Void( target, level, internalformat, width, height, border, format, type, pixels:DataBuffer )="_glTexImage2D"
Function glTexSubImage2D:Void( target, level, xoffset, yoffset, width, height, format, type, pixels:DataBuffer )="_glTexSubImage2D"
Function glTexSubImage2D:Void( target, level, xoffset, yoffset, width, height, format, type, from, pixels:DataBuffer )="_glTexSubImage2D2"
...
Function glUniformMatrix3fv:Void( location, count, transpose?, value#[] )="_glUniformMatrix3fv"
Function glUniformMatrix4fv:Void( location, count, transpose?, value#[] )="_glUniformMatrix4fv"
Function glUseProgram:Void( program )="_glUseProgram"
...
Function glDrawElements:Void(mode, count, type, ptr:DataBuffer, offset) = "_glDrawElements"

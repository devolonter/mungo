...
Class MyApp Extends App
	...
	Method OnCreate()
		...
		Local d1:=New DataBuffer(4, True)
		local d2:=New DataBuffer(4, True)
		
		d1.PokeInt(0, 99)
		
		CopyDataBufferToDataBuffer(d1, d2)
		
		Print d2.PeekInt(0)
		
		CopyFloatsToDatabuffer([90], d2, 0)
		
		Print d2.PeekFloat(0)
		
		CopyFloatsToDatabuffer([90.5], d2, 0)
